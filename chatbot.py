...
printLines(os.path.join(corpus, "en-fr.txt"))
...
datafile = os.path.join(corpus, "en-fr.txt")
...
print("\nProcessing corpus...")
pairs = loadLines(os.path.join(corpus, "en-fr.txt"))
...
def loadPrepareData(pairs):
    ...
    print("Counted words input:", voc.num_words)
    return voc, pairs


# Load/Assemble voc and pairs
save_dir = os.path.join("data", "save")
voc, pairs = loadPrepareData(pairs)
# voc, pairs = loadPrepareData(...)
#some pairs to validate
print("\npairs:")
...
def evaluatedataset(encoder, decoder, searcher, voc, test_data):
    """
    ...
    for x_batch in test_data:
        ...
        for x in x_batch:
            ...
            output_words = evaluate(encoder, decoder, searcher, voc, x)
            output_post  = [x for x in output_words if not (x == 'EOS' or x == 'PAD')]
...
evaluatedataset(encoder, decoder, searcher, voc, pairs_val)
